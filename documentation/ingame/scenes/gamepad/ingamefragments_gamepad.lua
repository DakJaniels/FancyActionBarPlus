...
GAMEPAD_QUICKSLOT_FRAGMENT = ZO_SimpleSceneFragment:New(ZO_Quickslot_Gamepad_TopLevel)
GAMEPAD_QUICKSLOT_FRAGMENT:SetHideOnSceneHidden(true)
GAMEPAD_QUICKSLOT_SELECTED_TOOLTIP_FRAGMENT = ZO_FadeSceneFragment:New(ZO_Quickslot_Gamepad_TopLevelSelectedTooltipContainer)
...
UNIVERSAL_DECONSTRUCTION_GAMEPAD_FRAGMENT = ZO_SimpleSceneFragment:New(ZO_UniversalDeconstructionTopLevel_Gamepad)
UNIVERSAL_DECONSTRUCTION_GAMEPAD_FRAGMENT:SetHideOnSceneHidden(true)
UNIVERSAL_DECONSTRUCTION_MODE_GAMEPAD_FRAGMENT = ZO_SimpleSceneFragment:New(ZO_UniversalDeconstructionTopLevel_GamepadMaskContainer)
UNIVERSAL_DECONSTRUCTION_INVENTORY_GAMEPAD_FRAGMENT = ZO_SimpleSceneFragment:New(ZO_UniversalDeconstructionTopLevel_GamepadMaskPanelInventory)
UNIVERSAL_DECONSTRUCTION_FLOATING_GAMEPAD_FRAGMENT = ZO_FadeSceneFragment:New(ZO_UniversalDeconstructionTopLevel_GamepadFloating)
