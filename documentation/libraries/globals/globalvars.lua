...
WINDOW_MANAGER = GetWindowManager() or WindowManager
ANIMATION_MANAGER = GetAnimationManager() or AnimationManager
EVENT_MANAGER = GetEventManager() or EVENT_MANAGER
