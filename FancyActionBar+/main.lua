...
function FancyActionBar.ClearAnchors()
    ...
    if ActionButton23 then
        ActionButton23:ClearAnchors()
    end
    if ActionButtonOverlay3 then
        ActionButtonOverlay3:ClearAnchors()
    end
    if ActionButtonOverlay23 then
...
function FancyActionBar.Initialize()
    ...
    if useSlotsOverride then
        if not FancyActionBar.Compatability.Xvfoo_Enabled then
...
function FancyActionBar.OnAddOnLoaded(event, addonName)
    if addonName == NAME then
        ...
        FancyActionBar.Compatability.LibMediaProvider_Enabled = is_it_enabled("LibMediaProvider-1.0")
        ...
        FancyActionBar.Compatability.Xvfoo_Enabled = is_it_enabled("Xvfoo")
    end
end
