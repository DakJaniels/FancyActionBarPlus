...
local function CreateFAQTexture(control)
    ...
    local helpUrl = GetStringFromValue(controlData.helpUrl)
    if not helpUrl or helpUrl == "" then
        return
    end
    ...
    faqControl.data = {
        helpUrl = helpUrl,
        tooltipText = FAQ_ICON_TOOTIP_TEMPLATE:format(util.L.WEBSITE, helpUrl),
    }
    ...
    faqControl:SetHandler("OnMouseEnter", function (self)
        ...
        self:SetColor(FAQ_ICON_MOUSE_OVER_COLOR:UnpackRGBA())
